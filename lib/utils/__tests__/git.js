...
describe('Git', function() {
    ...
    describe('URL parsing', function() {
        ...
        it('should correctly validate git urls', function() {
            ...
            // SSH
            expect(Git.isUrl('git+git@github.com:gitbook-ng/gitbook.git/directory/README.md#e1594cde2c32e4ff48f6c4eff3d3d461743d74e1')).toBeTruthy();
        ...
        it('should parse SSH urls', function() {
            var parts = Git.parseUrl('git+git@github.com:gitbook-ng/gitbook.git/directory/README.md#e1594cde2c32e4ff48f6c4eff3d3d461743d74e1');

            expect(parts.host).toBe('git@github.com:gitbook-ng/gitbook.git');
